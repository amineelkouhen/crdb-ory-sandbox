...
Once your environment is set, you can simulate traffic to the Ory applications using the [Workload Simulator](https://github.com/amineelkouhen/crdb-ory-load-test) - already integrated in the client.
